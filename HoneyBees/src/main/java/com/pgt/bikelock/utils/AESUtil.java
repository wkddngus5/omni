...
public class AESUtil {
	public static final String VIPARA =  OthersSource.getSourceString("sms_api_vipara");  
	...
	public static void main(String[] args) {
		String content="645511738@qq.com";  
		String password=OthersSource.getSourceString("sms_api_key");
		String jiamiresult= "qRVyzL3RTeVEJNS1cR45QbO2mQK1WcoaT6m+y11UP40=";//AESUtil.aesEncrypt(content, password);
