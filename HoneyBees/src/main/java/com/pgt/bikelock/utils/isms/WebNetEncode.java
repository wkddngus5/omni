 ...
 */
package com.pgt.bikelock.utils.isms;
...
public class WebNetEncode {
    ...
    //字符编码成HEX/character encoded into HEX
    public static String toHexString(String s) {
        ...
        return "0x" + str;//0x表示十六进制//0x means hexadecimal
    }

//转换十六进制编码为字符串/Convert hexadecimal to string
    public static String toStringHex(String s) {
     ...
     /** *//**
     * 把字节数组转换成16进制字符串/Convert byte array to hexadecimal string
     * @param bArray
     * @return
     */
 public static final String bytesToHexString(byte[] bArray) {
    ...
    //hex编码还原成字符/ hex code returned to character
