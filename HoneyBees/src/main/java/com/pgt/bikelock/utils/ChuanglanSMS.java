 ...
 * @Description:创蓝国内短信通道/chuanglan domestic SMS channel
 * @author:    Albert
...
public class ChuanglanSMS {
	 ...
	 * @param url
	 *            应用地址，类似于http://ip:port/msg/ /application address, similar to http://ip:port/msg/
	 * @param account
	 *            账号/account
	 * @param pswd
	 *            密码/password
	 * @param mobile
	 *            手机号码，多个号码使用","分割/phone number, muti number used "," segment
	 * @param msg
	 *            短信内容/message content
	 * @param rd
	 *            是否需要状态报告，需要1，不需要0/ need the status report or not, yes 1, no 2  
	 * @return 返回值定义参见HTTP协议文档/return value refer to HTTP agreement files
	 * @throws Exception
	 */
	...
	/**
	 *   get 发送普通短信/send common message
	 * @param url
	 *            应用地址，类似于http://ip:port/msg/ /application address, similar to http://ip:port/msg/
	 * @param account
	 *            账号/account
	 ...
	 * @return 返回值定义参见HTTP协议文档/return value definition reference to HTTP agreement file
	 * @throws Exception
	 */
	 ...
	 * @param count	       拉取数量/pull quantity
	 * @return
	 * @throws Exception
	 */
	 ...
	 *            密码/password
	 * @param params
	 *            变量值如 18724118999,内容。。。。多个手机号码 后面用“;”分开 /take 18724118999 as variable value, content ... multi phnoe no. divided by ","
	 * @param msg
	 *            短信内容/content message
	 * @param needstatus
	 *            是否需要状态报告，需要true，不需要false/need the status report or not, yes true, no false
	 * @return 返回值定义参见HTTP协议文档/return value definition reference to HTTP agreement file
	 * @throws Exception
