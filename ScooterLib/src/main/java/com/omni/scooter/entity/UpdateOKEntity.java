 ...
 *
 */
public class UpdateOKEntity extends BaseEntity{

	public UpdateOKEntity() {
		super();
	}

	public UpdateOKEntity(String content) {
		super(content);
	}
	...
	public String toString() {
		return "UpdateOKEntity [getIotVersion()=" + getIotVersion() + ", getIotCode()=" + getIotCode()
