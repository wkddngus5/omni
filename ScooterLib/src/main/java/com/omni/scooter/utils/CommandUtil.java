package com.omni.scooter.utils;
...
public class CommandUtil {
	...
	public static byte[] getCommand(String code,String IMEI,String orderCode,String content){
		...
		String command =String.format("%s,%s,%s,%s%s\n", Command.SEND_HEAD,code,IMEI,orderCode,content);
	...
	public static byte[] getCommand( String IMEI,String orderCode,String content){
		String command =String.format("%s,%s,%s,%s%s\n", Command.SEND_HEAD,Command.CODE,IMEI,orderCode,content);
		byte[] orderContect=command.getBytes(); 
		return add(order00,orderContect);
	}
	 ...
	 * @return
	 */
	public static byte[] getStartUpComm(String IMEI,int nPack,int size,int crcInt,String deviceType,String upCode){
	...
	public static byte[] getUpdateDetailComm( String IMEI, int npack,int crc,byte[] updateItem){
		String commad = String.format("%s,%s,%s,%s,%s,%s,",Command.SEND_HEAD,Command.CODE,IMEI,Command.ORDER_UPDATE,npack,crc);
